...
import { MapPin, Clock, Car, QrCode, X, ArrowLeft, IndianRupee, Hash } from 'lucide-react';
  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        {/* QR Modal */}
        <Modal open={showQR} onClose={() => setShowQR(false)} title="Your Entry QR Code" size="sm">
          <div className="text-center space-y-4">
            <img src={booking.qrCode} alt="Booking QR" className="w-48 h-48 mx-auto rounded-xl bg-white p-2" />
            <p className="text-xs text-neutral-500">Show this QR code at the parking entrance. Valid until checkout.</p>
            <p className="text-sm font-mono text-emerald-400">{booking.bookingRef}</p>
          </div>
        </Modal>
